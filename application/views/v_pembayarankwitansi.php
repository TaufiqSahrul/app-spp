...
<html lang="en" id="areaprint">
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="<?php echo base_url();?>img/igasar.png">
      </div>
      <h1>NO PEMBAYARAN : <?php echo $rkwitansi['id_pembayaran'];?></h1>
      <div id="company" class="clearfix">
        <div>SMK Igasar Pindad</div>
        <div>Jl.Cisaranten Kulon Kec.Cinambo,No.17<br /> Kota Bandung, Jawa Barat</div>
        <div>(602) 519-0450</div>
        <div><a href="#">www.smksigasarpindad.sch.id</a></div>
      </div>
      <div id="project" >
        ...
        <div>TANGGAL PEMBAYARAN <?php echo $tgl; ?></div>
        <div>NAMA PETUGAS <?php echo $rkwitansi['nama_petugas'];?></div>
      </div>
    </header>
    <main>
      <table>
